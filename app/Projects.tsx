...
const translations = {
  ...
  es: {
    ...
    d6: "Sistema de gestión de repertorio musical, con autenticación basada en roles director/músico, sincronización en tiempo real entre el director y los músicos durante el vivo, armado de listas de canciones con letra y acordes en formato ChordPro, y un modo demo sin credenciales con contenido de muestra para explorar la app.",
    visit: "Visitar",
    code: "Código",
  },
};
