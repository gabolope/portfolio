...
const translations = {
  en: {
    ...
    o2d: "Inventory systems, payment processing, automated messaging. Stop tracking orders on paper or losing time on manual, repetitive tasks.",
    o3t: "AI-Powered Features",
    o3d: "A bot that answers WhatsApp questions after hours, a search that understands plain language instead of exact keywords. Practical AI.",
  ...
  es: {
    ...
    o2d: "Sistemas de inventariado, de cobro, de mensajería automática. Dejá de anotar pedidos en un cuaderno o de perder tiempo en tareas repetitivas.",
    o3t: "Funcionalidades con IA",
    o3d: "Un bot que responde consultas por WhatsApp fuera de horario, un buscador que entiende lenguaje natural en vez de palabras clave exactas. IA útil.",
